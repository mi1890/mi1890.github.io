              ...
              code: ({ node, inline, className, children, ...props }) => {
                ...
                return !inline ? (
                  <div className="relative my-6 not-prose group">
                    ...
                    <pre className="bg-gray-900 text-gray-100 rounded-b-lg p-4 overflow-x-auto shadow-lg border border-gray-700 border-t-0">
                      <code 
                        className="font-mono text-sm leading-snug text-gray-100"
                        {...props}
